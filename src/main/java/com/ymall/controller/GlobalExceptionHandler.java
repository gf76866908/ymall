...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public Object handIllegalException(IllegalException e) {return e.getErrorObject();}

    //未授权 401
    @ExceptionHandler(UnauthorizedException.class)
    @ResponseStatus(value = HttpStatus.UNAUTHORIZED)
    public Object handUnauthorizedException(UnauthorizedException e) {return e.getErrorObject();}


    //未找到资源 404
    @ExceptionHandler(NotFoundException.class)
    @ResponseStatus(value = HttpStatus.NOT_FOUND)
    public Object handNotFoundException(NotFoundException e) {return e.getErrorObject();}
